...
BOT_TOKEN = environ.get('BOT_TOKEN', "8944472284:AAGBn6MSlriknMNfw-M1uIxK3moOKSKNBrg")
...
AUTH_REQ_CHANNELS = [int(ch) for ch in environ.get("AUTH_REQ_CHANNELS", "-1002493712153").split() if ch and id_pattern.match(ch)]
